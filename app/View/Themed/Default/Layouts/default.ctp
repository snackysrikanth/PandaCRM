...
<html lang="en">
  ...
  <body>
			    ...
			    <ul class="nav pull-right">
		        	...
		        	<li class="dropdown <?php if(($this->params['controller']=='users') and ($this->params['action']=='index')) echo 'active'; ?>">
						...
						<ul class="dropdown-menu" >
						      <li><?php echo $this->Html->link('',array('plugin'=>'','controller'=>'users','action'=>'index')); ?></li>
						      <li><?php echo $this->Html->link(' ',array('plugin'=>'','controller'=>'options','action'=>'edit')); ?></li>
						</ul>
		        	</li>
		        	<?php endif; ?>
    ...
    <div class="container main-wraper">
	 ...
	 <div class="footer">
      <div class="copyright">
      Copyright &copy; 2015 &nbsp;| Vijyetha | Srikanth 
      </div>
      </div>
    <!-- Le javascript
    ================================================== -->
